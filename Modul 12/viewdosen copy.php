...
<body>
    ...
    <div class="card fade-in">
        <div class="actions-bar">
            <!-- Search Bar -->
            <form method="GET" action="viewdosen copy.php" class="search-bar">
                ...
                <?php if(isset($_GET['kata_kunci']) && $_GET['kata_kunci'] != '') { ?>
                    <a href="viewdosen copy.php" class="btn btn-danger btn-sm" style="display: flex; align-items: center; justify-content: center; height: 100%; text-decoration: none;">Reset</a>
                <?php } ?>
            </form>
